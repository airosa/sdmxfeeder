...
(function() {
  var CONVERT, ConvertCompactPipe, PASSTHROUGH, SETUP, WAITING_CONVERT, WAITING_PASSTHROUGH, sdmx,
  ...
  ConvertCompactPipe = (function(_super) {
      ...
      switch (sdmxdata.type) {
        ...
        case sdmx.ATTRIBUTE_GROUP:
          ...
          if (sdmxdata.data.components != null) {
            ...
            if (ref != null) {
              this.registry.query(sdmx.DATA_STRUCTURE_DEFINITION, ref, this.doCallbackForFind);
            } else {
