...
(function() {
  var addConceptIdentity, addEnumeration, addTextFormat, attributeCur, codeCur, codeListCur, comp, conceptCur, conceptSchemeTmp, conceptsCur, dimensionPos, dsdCur, entryActions, exitActions, groupCur, guards, header, keyFamilyCur, primaryMeasureCur, renameProperty, sdmx, _;
  ...
  addConceptIdentity = function(component, attrs) {
    ...
    return (_ref = (_base = component.conceptIdentity.ref).maintainableParentVersion) != null ? _ref : _base.maintainableParentVersion = '1.0';
  };
