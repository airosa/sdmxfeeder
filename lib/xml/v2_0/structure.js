...
(function() {
  var addConceptIdentity, addEnumeration, addTextFormat, attributeCur, codeCur, codeListCur, comp, conceptCur, conceptSchemeCur, conceptSchemeTmp, conceptsCur, dimensionPos, dsdCur, entryActions, exitActions, groupCur, guards, header, keyFamilyCur, primaryMeasureCur, renameProperty, sdmx, _;
  ...
  addConceptIdentity = function(component, attrs) {
    ...
    if ((_ref = component.id) == null) {
      component.id = attrs.conceptRef;
    }
    component.conceptIdentity.ref = {};
    component.conceptIdentity.ref.id = attrs.concept;
    if ((_ref1 = (_base = component.conceptIdentity.ref).id) == null) {
      _base.id = attrs.conceptRef;
    }
    component.conceptIdentity.ref.agencyID = attrs.conceptAgency;
    if ((_ref2 = (_base1 = component.conceptIdentity.ref).agencyID) == null) {
      _base1.agencyID = attrs.conceptSchemeAgency;
    }
    if ((_ref3 = (_base2 = component.conceptIdentity.ref).agencyID) == null) {
      _base2.agencyID = dsdCur.agencyID;
    }
    if ((_ref4 = (_base3 = component.conceptIdentity.ref).maintainableParentID) == null) {
      _base3.maintainableParentID = attrs.conceptSchemeRef;
    }
    if ((_ref5 = (_base4 = component.conceptIdentity.ref).maintainableParentID) == null) {
      _base4.maintainableParentID = 'CONCEPTS';
    }
    component.conceptIdentity.ref.maintainableParentVersion = attrs.conceptVersion;
    if ((_ref6 = (_base5 = component.conceptIdentity.ref).maintainableParentVersion) == null) {
      _base5.maintainableParentVersion = attrs.conceptSchemeVersion;
    }
    return (_ref7 = (_base6 = component.conceptIdentity.ref).maintainableParentVersion) != null ? _ref7 : _base6.maintainableParentVersion = '1.0';
  };
  ...
  entryActions = {
    ...
    'Concepts': function(attrs) {
      return conceptSchemeTmp = null;
    },
    'Concepts/ConceptScheme': function(attrs) {
      conceptSchemeCur = _.extend({}, attrs);
      return conceptSchemeCur.concepts = {};
    },
    'Concepts/ConceptScheme/Concept': function(attrs) {
      return conceptCur = _.extend({}, attrs);
    },
    'Concepts/Concept': function(attrs) {
      var _base, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      if (conceptSchemeTmp == null) {
        conceptSchemeTmp = {};
      }
      if ((_ref = conceptSchemeTmp.id) == null) {
        conceptSchemeTmp.id = 'CONCEPTS';
      }
      if ((_ref1 = conceptSchemeTmp.agencyID) == null) {
        conceptSchemeTmp.agencyID = attrs.agency;
      }
      if ((_ref2 = conceptSchemeTmp.agencyID) == null) {
        conceptSchemeTmp.agencyID = attrs.agencyID;
      }
      if ((_ref3 = conceptSchemeTmp.name) == null) {
        conceptSchemeTmp.name = {};
      }
      if ((_ref4 = (_base = conceptSchemeTmp.name).en) == null) {
        _base.en = 'Statistical concepts';
      }
      if ((_ref5 = conceptSchemeTmp.concepts) == null) {
    ...
    'KeyFamilies/KeyFamily/Components/Attribute': function(attrs) {
      ...
      if (attrs.attachmentLevel === 'Series') {
        comp.attributeRelationship.dimensions = this.dimensions;
      }
      if (attrs.attachmentLevel === 'Group') {
        return comp.attributeRelationship.dimensions = this.dimensions.slice(1);
      }
    },
  ...
  exitActions = {
    ...
    'Concepts/ConceptScheme/Concept': function() {
    ...
    'Concepts': function(attrs) {
      if (conceptSchemeTmp != null) {
        return this.emitSDMX(sdmx.CONCEPT_SCHEME, conceptSchemeTmp);
      }
    },
    'Concepts/ConceptScheme': function(attrs) {
      return this.emitSDMX(sdmx.CONCEPT_SCHEME, conceptSchemeCur);
    },
    'Concepts/ConceptScheme/Name': function(attrs) {
      var _ref, _ref1;
      if ((_ref = attrs['xml:lang']) == null) {
        attrs['xml:lang'] = 'en';
      }
    ...
    'Concepts/ConceptScheme/Concept/Name': function(attrs) {
      var _ref, _ref1;
      if ((_ref = attrs['xml:lang']) == null) {
        attrs['xml:lang'] = 'en';
      }
    ...
    'KeyFamilies/KeyFamily': function(attrs) {
      return this.emitSDMX(sdmx.DATA_STRUCTURE_DEFINITION, dsdCur);
    },
    ...
    'KeyFamilies/KeyFamily/Components/Attribute/AttachmentMeasure': function(attrs) {
      var _ref;
      if ((_ref = attributeCur.AttachmentMeasure) == null) {
    ...
    'KeyFamilies/KeyFamily/Components/Attribute/AttachmentGroup': function(attrs) {
      var _ref;
      if ((_ref = comp.attributeRelationship) == null) {
        comp.attributeRelationship = {};
      }
