...
(function() {
  var contactCur, entryActions, exitActions, guards, headerCur, partyCur, structureCur, util, xmlns_msg, _;
  ...
  entryActions = {
    ...
    'Header/Structure': function(attrs) {
      return structureCur = _.extend({}, attrs);
    },
    'Header/Structure/Structure/Ref': function(attrs) {
      structureCur.structureRef = {};
      return structureCur.structureRef.ref = _.extend({}, attrs);
    }
  };
  ...
  exitActions = {
    ...
    'Header/Truncated': function() {
      return headerCur.truncated = this.stringBuffer === 'true';
    },
    ...
    'Header/Structure': function(attrs) {
      var _ref;
      if ((_ref = headerCur.structure) == null) {
        headerCur.structure = {};
      }
    ...
    'Header/DataSetAgency': function() {
      return headerCur.dataSetAgency = this.stringBuffer;
    },
    ...
    'Header/ReportingBegin': function() {
      return headerCur.reportingBegin = util.xmlDateToJavascriptDate(this.stringBuffer);
    },
    'Header/ReportingEnd': function() {
      return headerCur.reportingEnd = util.xmlDateToJavascriptDate(this.stringBuffer);
    },
