...
(function() {
  var SDMXToStringStream, XMLWriter, builder, stringifiers, util,
  ...
  XMLWriter = (function(_super) {

    __extends(XMLWriter, _super);

    XMLWriter.name = 'XMLWriter';

    function XMLWriter(log) {
      this.header = {};
      this.rootElemName = '';
      this.doc = builder.create();
      XMLWriter.__super__.constructor.apply(this, arguments);
    }

    XMLWriter.prototype.before = function(type, data) {
      var str;
      str = '';
      switch (type) {
        case 'header':
    ...
    XMLWriter.prototype.beforeFirst = function(type) {
      var str;
      str = '';
      switch (type) {
        case 'codelist':
    ...
    XMLWriter.prototype.stringify = function(type, data) {
      switch (type) {
        case 'codelist':
    ...
    XMLWriter.prototype.afterLast = function(type) {
      switch (type) {
        case 'codelist':
          return '</Codelists>\n';
        case 'conceptScheme':
