...
(function() {
  var EdifactParser, parseFormat;

  parseFormat = function(formatString) {
    var all, dots, format, length, pattern, textType, _ref;
    pattern = /^([AN]+)([\.]*)(\d+)$/;
    _ref = formatString.match(pattern), all = _ref[0], textType = _ref[1], dots = _ref[2], length = _ref[3];
    format = {};
    format.textType = (function() {
      switch (textType) {
        case 'A':
          return 'Alpha';
        case 'N':
