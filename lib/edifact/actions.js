...
(function() {
  var ARRAY_CELL, ATTACHMENT_LEVEL, ATTRIBUTE, DATA, DATASET, DATASETLIST, DEFINITIONS, DIMENSION, FREQUENCY, OBSERVATION, REPRESENTATION, SIBLING_GROUP, TIME, TIMESERIES, USAGE_STATUS, entryActions, exitActions, guards, parseFormat, processDescription, time, _;
  ...
  entryActions = {
    ...
    'UNB/UNH/VLI': function(p, spec) {
      ...
      if (this.helper.maintenanceAgency != null) {
        return this.codelist.agencyID = this.helper.maintenanceAgency;
      }
    },
    ...
    'UNB/UNH/ASI': function(p, spec) {
      if (!_.isEmpty(this.conceptScheme.concepts)) {
        this.emit('conceptScheme', this.conceptScheme);
        this.conceptScheme.concepts = {};
      }
    ...
    'UNB/UNH/ASI/SCD': function(p, spec) {
      ...
      return this.component.conceptIdentity.ref.maintainableParentID = 'CONCEPTS';
    },
    ...
    'UNB/UNH/ASI/SCD/IDE': function(p, spec) {
      ...
      return this.component.localRepresentation.enumeration.ref.agencyID = this.helper.maintenanceAgency;
    },
    ...
    'UNB/UNH/DSI/IDE': function(p, spec) {
      ...
      this.header.structure.structureID = spec.dsd;
      this.header.structure.dimensionAtObservation = 'TIME_PERIOD';
      this.header.structure.structure = {};
      this.header.structure.structure.ref = {};
      this.header.structure.structure.ref.id = spec.dsd;
      this.header.structure.structure.ref.agencyID = this.helper.maintenanceAgency;
    ...
    'UNB/UNT': function(p, spec) {
      if (!_.isEmpty(this.conceptScheme.concepts)) {
        this.emitSDMX('conceptScheme', this.conceptScheme);
        this.conceptScheme.concepts = {};
      }
  ...
  exitActions = {
    'UNB/UNH/BGM': function() {
      if (this.helper.messageFunction === DEFINITIONS) {
        return this.emitSDMX('header', this.header);
      }
    },
    'UNB/UNH/DSI/IDE': function() {
      if (this.helper.messageFunction === DATA) {
        this.emitSDMX('header', this.header);
        return this.emitSDMX('dataSet', this.dataSetBegin);
      }
    },
    'UNB/UNH/VLI': function() {
      return this.emitSDMX('codelist', this.codelist);
    },
    'UNB/UNH/ASI': function() {
      return this.emitSDMX('dataStructure', this.dsd);
    },
    ...
    'UNB/UNH/DSI/ARR': function() {
      return this.emitSDMX('series', this.series);
    },
    'UNB/UNH/DSI/FNS/REL/ARR': function() {
      switch (this.helper.attributeScope) {
        case OBSERVATION:
        case TIMESERIES:
          return this.emitSDMX('series', this.attributes);
        case SIBLING_GROUP:
          this.attributes.type = 'SiblingGroup';
          return this.emitSDMX('group', this.attributes);
        case DATASET:
          return this.emitSDMX('dataSetAttributes', this.attributes);
      }
    }
  };
