...
(function() {
  var convertForJSON, convertForJSON2, extendSchema, schemas;
  ...
  extendSchema = function(schema, root) {
    var extended, property, property2, tmp, value, value2;
    extended = {};
    tmp = {};
    if ((schema["extends"] != null) && (root[schema["extends"]] != null)) {
    ...
    for (property in schema) {
      ...
      if (extended[property] != null) {
        if (typeof extended[property] === 'object') {
          for (property2 in value) {
  ...
  convertForJSON = function(schema) {
    var key, value;
    for (key in schema) {
      value = schema[key];
  ...
  convertForJSON2 = function(schema) {
    var key, value, _ref, _results;
    if ((schema.type != null) && schema.type === 'date') {
      schema.type = 'string';
    ...
    if (schema.properties != null) {
      ...
      for (key in _ref) {
        value = _ref[key];
        _results.push(convertForJSON2(value));
      }
      return _results;
    }
  };
