...
(function() {
  var Log, SimpleRegistry, argv, async, createReadStream, createWriteStream, destinationPath, factory, fileIsCompressed, findFiles, fs, getFileFormat, loadStructuresFromFiles, log, optimist, options, path, processInputFile, registry, sourcePath, start, zlib,
    _this = this;
  ...
  processInputFile = function(callback) {
    var destination, formatIn, formatOut, gzipIn, gzipOut, pipe, pipes, source;
  ...
  fileIsCompressed = function(fullpath) {
    var _ref;
    return (_ref = path.extname(fullpath)) === '.gz' || _ref === '.zip';
  };
