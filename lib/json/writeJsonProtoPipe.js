...
(function() {
  ...
  WriteJsonProtoPipe = (function(_super) {
    ...
    WriteJsonProtoPipe.prototype.getDimRole = function(dimID) {
      var dsd;
      dsd = this.structures.dataStructureDefinitions[this.dsdKey];
    ...
    WriteJsonProtoPipe.prototype.buildObsAttribute = function(attrId, msg, cache) {
      var attrObj, code, count, i, maxCount, maxValue, series, val, valCount, value, values, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3;
      ...
      if (this.attrIsCoded(attrId)) {
        ...
        for (i = _k = 0, _len2 = _ref3.length; _k < _len2; i = ++_k) {
          ...
          attrObj.code.name[code] = this.getAttrCodeName(code, attrId);
        }
      }
      ...
      if (valCount !== 0 && valCount < (attrObj.size / 10)) {
    ...
    WriteJsonProtoPipe.prototype.buildAttribute = function(attrId, attrObj, data, msg) {
      var code, codes, dim, i, index, key, multipliers, obj, prev, reversedDims, valCount, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3;
      attrObj.name = this.getAttrName(attrId);
      attrObj.mandatory = this.getAttrMandatory(attrId);
      attrObj.role = null;
      attrObj.code = null;
      ...
      if (this.attrIsCoded(attrId)) {
        ...
        return attrObj.code.size = attrObj.code.id.length;
      }
    };

    WriteJsonProtoPipe.prototype.buildDimension = function(dimId, dimObj, cache) {
      var code, group, i, series, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
      dimObj.name = this.getDimName(dimId);
      dimObj.role = this.getDimRole(dimId);
      dimObj.code = {
        id: [],
        index: {},
        name: {}
      ...
      if (dimId === cache.obsDimension) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            ...
            if (dimObj.code.name[code] != null) {
              continue;
            }
            dimObj.code.name[code] = this.getDimCodeName(code, dimId, dimObj.role);
          }
        }
      } else {
        _ref2 = cache.series;
      ...
      _ref4 = Object.keys(dimObj.code.name).sort();
      for (i = _m = 0, _len4 = _ref4.length; _m < _len4; i = ++_m) {
        code = _ref4[i];
        dimObj.code.id[i] = code;
        dimObj.code.index[code] = i;
      }
      return dimObj.code.size = dimObj.code.id.length;
    };

    WriteJsonProtoPipe.prototype.buildMeasure = function(measureId, msg, cache) {
      var code, codeCount, codeIndex, dim, i, index, key, measureObj, obsIndex, prev, series, value, _i, _j, _len, _len1, _ref, _ref1, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        series = _ref[_i];
        index = 0;
        prev = msg.dimension[this.cache.obsDimension].code.size;
        _ref1 = msg.dimension.id.slice().reverse();
        for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
          dim = _ref1[i];
        ...
        _results.push((function() {
          ...
          for (i = _k = 0, _len2 = _ref2.length; _k < _len2; i = ++_k) {
            code = _ref2[i];
            obsIndex = index + msg.dimension[this.cache.obsDimension].code.index[code];
            ...
            _results1.push((function() {
              ...
              for (key in _ref3) {
                ...
                if (value[i] !== msg.attribute[key]["default"]) {
                  _results2.push(msg.attribute[key].value[obsIndex] = value[i]);
                } else {
    ...
    WriteJsonProtoPipe.prototype.buildMessage = function() {
      var attr, attrObj, dim, i, measureId, msg, obsCount, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      msg = {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        dim = _ref[i];
        msg.dimension[dim] = {};
        this.buildDimension(dim, msg.dimension[dim], this.cache);
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        if (attrObj.dimension.length === msg.dimension.id.length - 1) {
      ...
      for (_l = 0, _len3 = _ref5.length; _l < _len3; _l++) {
        ...
        this.buildMeasure(measureId, msg, this.cache);
      }
      this.log.info('starting to produce JSON');
      this.emitData(JSON.stringify(msg, false, 2));
