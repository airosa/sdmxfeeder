...
(function() {
  ...
  SimpleRegistry = (function() {
    ...
    SimpleRegistry.prototype.query = function(type, ref, callback) {
      var result, _ref, _ref1, _ref2;
      this.log.debug("" + this.constructor.name + " query");
      result = (_ref = this.cache[type]) != null ? (_ref1 = _ref[ref.agencyID]) != null ? (_ref2 = _ref1[ref.id]) != null ? _ref2[ref.version] : void 0 : void 0 : void 0;
